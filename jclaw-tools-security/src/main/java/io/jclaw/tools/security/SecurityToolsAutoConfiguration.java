...
/**
 * Auto-configuration that registers the security handshake tool into the JClaw ToolRegistry.
 ...
 *
 * <p>Configuration properties (prefix: {@code jclaw.security.handshake}):
 * <ul>
...
public class SecurityToolsAutoConfiguration {
    ...
    public SecurityHandshakeProperties securityHandshakeProperties(Environment environment) {
        return Binder.get(environment)
                .bind("jclaw.security.handshake", SecurityHandshakeProperties.class)
    ...
    @Bean
    @ConditionalOnMissingBean
    public HandshakeSessionStore handshakeSessionStore() {
